...
import com.example.hyhy.Adapters.CartAdapter;
...
public class CartFragment extends Fragment implements View.OnClickListener {
    ...
    private void init(View view) {
        ...
        cartModelList.add(new CartModel(R.drawable.h7,"1","Chicken","$3.0"));
        cartModelList.add(new CartModel(R.drawable.two,"1","Hambergur","$3.0"));
        cartModelList.add(new CartModel(R.drawable.h9,"1","Noodle soup","$3.0"));
        cartModelList.add(new CartModel(R.drawable.h10,"1","Bread","$3.0"));
